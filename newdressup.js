...
class SceneA extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("removebtn", "SLICES/bttn_removeselction.png");
    ...
    this.load.image("smartshirt", "SLICES/upperpri/smartshirt.png");
    this.load.image("denimshirt", "SLICES/upperpri/7top.png");
    this.load.image("stripedshirt", "SLICES/upperpri/2top.png");
    this.load.image("bluecoat", "SLICES/upperpri/4top.png");
    this.load.image("redcoat", "SLICES/upperpri/6top.png");
    this.load.image("architect", "SLICES/upperpri/architect.png");
    this.load.image("chef", "SLICES/upperpri/cheftop.png");
    this.load.image("firefighter", "SLICES/upperpri/firefighter.png");
    this.load.image("medicallabscientist", "SLICES/upperpri/s1.png");
    this.load.image("doctor", "SLICES/upperpri/doctor1.png");
    this.load.image("lawyer", "SLICES/upperpri/l1.png");
  }
  ...
  create() {
    ...
    this.add.sprite(1920 / 2, 400, "dressupbackground");
    this.add.sprite(1920 / 2, 30, "top").setDepth(11);
    let box = this.add.sprite(310, 500, "template").setDepth(9);
    box.visible = false;
            box.setScale(100, 150);
        box.setPosition(280, 320);

    this.add.sprite(250, 170, "nameholder");
    ...
    this.add.text(150, 150, playername, {
      font: "32px Arial",
      fill: "white",
    });
    this.add.sprite(1700, 170, "coinholder");
    ...
    const smartshirttop = this.add.image(320, 550, "smartshirt");
    smartshirttop.setScale(0.51);
    smartshirttop.setDepth(12);
    smartshirttop.setVisible(false);

    const denimshirttop = this.add.image(321, 550, "denimshirt");
    denimshirttop.setScale(0.55);
    denimshirttop.setDepth(12);
    denimshirttop.setVisible(false);

    const stripedshirttop = this.add.image(320, 548, "stripedshirt");
    stripedshirttop.setScale(0.54);
    stripedshirttop.setDepth(12);
    stripedshirttop.setVisible(false);

    const bluecoattop = this.add.image(320, 562, "bluecoat");
    bluecoattop.setScale(0.5);
    bluecoattop.setDepth(12);
    bluecoattop.setVisible(false);

    const redcoattop = this.add.image(320, 563, "redcoat");
    redcoattop.setScale(0.52);
    redcoattop.setDepth(12);
    redcoattop.setVisible(false);

    const architecttop = this.add.image(320, 545, "architect");
    architecttop.setScale(0.55);
    architecttop.setDepth(12);
    architecttop.setVisible(false);

    const cheftop = this.add.image(320, 565, "chef");
    cheftop.setScale(0.5);
    cheftop.setDepth(12);
    cheftop.setVisible(false);

    const firefightertop = this.add.image(320, 565, "firefighter");
    firefightertop.setScale(0.5);
    firefightertop.setDepth(12);
    firefightertop.setVisible(false);

    const medicallabscientisttop = this.add.image(320, 565, "medicallabscientist");
    medicallabscientisttop.setScale(0.52);
    medicallabscientisttop.setDepth(12);
    medicallabscientisttop.setVisible(false);

    const doctortop = this.add.image(320, 565, "doctor");
    doctortop.setScale(0.51);
    doctortop.setDepth(12);
    doctortop.setVisible(false);

    const lawyertop = this.add.image(320, 555, "lawyer");
    lawyertop.setScale(0.52);
    lawyertop.setDepth(12);
    ...
    tabs.getElement("panel").on(
      ...
      console.log(playercoin);
        ...
        if (filter == "Top") {
            ...
            //for engineer shirt top
            if (costUrl == "U10") {
                const top = engineershirttop.setVisible(true);
                smartshirttop.setVisible(false);
                denimshirttop.setVisible(false);
                stripedshirttop.setVisible(false);
                bluecoattop.setVisible(false);
            ...
            //for striped shirt top
            else if (costUrl == "U1") {
                engineershirttop.setVisible(false);
                smartshirttop.setVisible(false);
                denimshirttop.setVisible(false);
                stripedshirttop.setVisible(true);
                bluecoattop.setVisible(false);
                redcoattop.setVisible(false);
                architecttop.setVisible(false);
                cheftop.setVisible(false);
            ...
            //for fire fighter top
                ...
                architecttop.setVisible(false);
                cheftop.setVisible(false);
                firefightertop.setVisible(true);
                medicallabscientisttop.setVisible(false);
                doctortop.setVisible(false);
                lawyertop.setVisible(false);
                return;
            ...
            //for medical lab scientist top
                ...
                cheftop.setVisible(false);
                firefightertop.setVisible(false);
                medicallabscientisttop.setVisible(true);
                doctortop.setVisible(false);
                lawyertop.setVisible(false);
                return;
            }
        ...
        if (filter == "Pants") {
            if (localStorage.getItem("pantsmoney") == 0) {
                ...
                if (newCost > localStorage.getItem("pantsmoney")) {
                    var changeneedp = newCost - localStorage.getItem("pantsmoney");
                    console.log(changeneedp);
                    if (changeneedp > playercoin) {
                    return;}
                    else {
                        localStorage.setItem(0, localStorage.getItem("0") - changeneedp);}
                }
                    }
        ...
        localStorage.setItem(0, localStorage.getItem("0") - newCost);
            if (localStorage.getItem("hatmoney") == 0) {
                ...
                if (newCost > localStorage.getItem("hatmoney")) {
                    var changeneedh = newCost - localStorage.getItem("hatmoney");
                    if (changeneedh > playercoin) {
                    return;}
                    }
                }
        ...
        localStorage.setItem(0, localStorage.getItem("0") - newCost);
            if (localStorage.getItem("shoesmoney") == 0) {
                ...
                if (newCost > localStorage.getItem("shoesmoney")) {
                    var changeneeds = newCost - localStorage.getItem("shoesmoney");
                    if (changeneeds > playercoin) {
                    return;}
                    }
                }
        ...
        localStorage.setItem(0, localStorage.getItem("0") - newCost);
            if (localStorage.getItem("othermoney") == 0) {
                ...
                if (newCost > localStorage.getItem("othermoney")) {
                    var changeneedo = newCost - localStorage.getItem("othermoney");
                    if (changeneedo > playercoin) {
                    return;}
                    }
                }
    ...
    //--------------------------REMOVE BUTTON------------------------------
    let spriteremove = this.add.sprite(1330, 845, "removebtn")
    .setScale(0.8, 0.8).setInteractive();
